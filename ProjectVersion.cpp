...
//In The Form Of major.minor.incremental...
//0-)alfa&beta Parameters Added To Scale The Result Image(0.1.1)...
const char *ProjectVersion::version = "1.1.0";

const char* ProjectVersion::getProjectVersion() { 
