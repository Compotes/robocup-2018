...
void init_gpio() {
	...
	sys_unexport << SENSOR_1_READ_GPIO << endl;
	sys_unexport << SENSOR_2_READ_GPIO << endl;
	...
	sys_export << SENSOR_1_READ_GPIO << endl;
	sys_export << SENSOR_2_READ_GPIO << endl;
	...
	fstream sys_gpio_in;
	sys_gpio_in.open(GPIO_DIR + "gpio" + to_string(SENSOR_1_READ_GPIO) + "/direction", ios::out);
	sys_gpio_in << "in" << endl;
	sys_gpio_in.close();
	sys_gpio_in.open(GPIO_DIR + "gpio" + to_string(SENSOR_2_READ_GPIO) + "/direction", ios::out);
	sys_gpio_in << "in" << endl;
	sys_gpio_in.close();
	...
	sys_gpio_in.open(GPIO_DIR + "gpio" + to_string(SENSOR_1_READ_GPIO) + "/active_low", ios::out);
	sys_gpio_in << "1" << endl;
	sys_gpio_in.close();
	sys_gpio_in.open(GPIO_DIR + "gpio" + to_string(SENSOR_2_READ_GPIO) + "/active_low", ios::out);
	sys_gpio_in << "1" << endl;
	sys_gpio_in.close();
