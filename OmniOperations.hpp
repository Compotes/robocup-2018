...
public : 
	...
	cv::Mat* unwrap(cv::Mat& inputImg, bool isSmoothOnGPU);
private:
	//Fields...
	bool isInitialized;
	double sigma;
	...
	cv::Mat *flatImg;
	Unwrapper *unwrapper;
	cv::Ptr<cv::cuda::Filter> gaussianFilterGpu;/*Why Not Simple GaussianBlur : http://docs.opencv.org/modules/gpu/doc/image_filtering.html#gpu-filterengine-gpu */
	cv::cuda::GpuMat *dBlurredImg;
	//Methods...
