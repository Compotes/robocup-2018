...
Unwrapper.o: Unwrapper.cu
	$(NVCC) -ccbin g++ -m64 -gencode arch=compute_62,code=sm_62 -gencode arch=compute_62,code=sm_62 -gencode arch=compute_62,code=sm_62 -gencode arch=compute_62,code=compute_62 $(NVCCFLAGS) $(LFLAGS) -o $@ -c $<
